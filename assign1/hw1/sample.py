...
"""
This class defines one sample for input. You need to define all attributes in this class. After that you can initialize the values used in this class using a list. You can get a dictionary about all values in the class. Besides, you can get value for specific attribute.
"""
class Sample:
	"""
	Constructor.
